...
#### 5. 经验
- coress的时候，如果ignore_bin+ binsof,则将全部该bin的组合都忽略掉了，后续ingore,msg_id_inv&msg_id_prg_rsp 哦度是和reg_port_type.PORT_FPP corss
![](./99_img/Snipaste_2025-07-17_16-02-54.png)